...
The last step is to generate new blocks by clicking the <b>Mine Block</b> button to confirm the transaction you just broadcasted.
If you check the transaction ID in the explorer, it should show as confirmed, as shown below:
![confirmed](../public/confirmed.png)
<br />